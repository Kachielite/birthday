...
const HeroView = () => {
    return (
        <div className="w-screen h-[640px] lg:h-[840px] flex flex-row relative">
            ...
            <div
                className="absolute inset-0 bg-[#FFFDF2] bg-opacity-80 flex flex-col space-y-7 justify-center items-center text-[#646C64] text-[54px] lg:text-[84px] font-bold font-fredoka px-4">
                <h1>Duby’s</h1>
                <h1 className="hidden lg:block flex-shrink-0">Sip, Paint, and Worship</h1>
                <h1 className="lg:hidden block flex-shrink-0">Sip, Paint, and</h1>
