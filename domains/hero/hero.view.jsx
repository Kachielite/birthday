...
const HeroView = () => {
    return (
        <div className="w-screen h-[640px] lg:h-[840px] flex flex-row relative">
            ...
            <div
                className="absolute inset-0 bg-[#FFFDF2] bg-opacity-80 flex flex-col space-y-7 justify-center items-center text-[#646C64] text-[40px] lg:text-[84px] font-bold font-fredoka">
                <h1>Duby’s</h1>
