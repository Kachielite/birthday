...
const HeaderMobileNav = ({isOpen, items}) => {
    return(
        <div className={`right-0 ${isOpen ? "translate-y-14 z-40 bg-[#DCAE96] h-screen" : "-translate-y-96 -z-40 "} ease-in-out duration-500 absolute block lg:hidden w-screen pt-10`}>
