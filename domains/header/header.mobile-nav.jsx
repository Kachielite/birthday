...
const HeaderMobileNav = ({isOpen, items}) => {
    return(
        <div className={`fixed right-0 ${isOpen ? "translate-y-14 z-40 bg-[#FFFDF2] h-fit" : "-translate-y-96 -z-40 "} ease-in-out duration-500 absolute block lg:hidden w-screen mt-48`}>
