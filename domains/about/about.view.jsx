...
const AboutView = () => {
    return (
        <div id="about" className="w-full bg-[#FFFDF2] h-fit lg:h-[730px] flex flex-col lg:flex-row justify-center items-center space-y-6 lg:space-y-0 lg:space-x-20 py-8 px-4 lg:px-20">
            <div className="w-full lg:w-[50%]">
                <AboutDetails />
            </div>
            <div className="w-full lg:w-fit relative flex justify-center items-center">
